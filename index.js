...
function addGamesToPage(games) {
    ...
    for (let game of games) {
        ...
        // Set the inner HTML of the div to display game info
        gameCard.innerHTML = `
        ...
        // Append the game card to the games-container element
...
const unfundedGamesText = `
    A total of ${numUnfundedGames} game${numUnfundedGames === 1 ? "" : "s"} 
    ${numUnfundedGames === 1 ? "remains" : "remain"} unfunded. 
